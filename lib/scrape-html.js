...
module.exports.scrapeHTML = function ($, opts) {
    ...
    var normalizeOpt = function normalizeOpt(v) {
        ...
        iterateObj(data, function (cOpt, optName) {
            ...
            if (!$cContext && !cOpt.selector && !cOpt.listItem) {
                throw new Error("There is no element selected for the '<option.name>' field. Please provide a selector, list item or use nested object structure.");
            }
